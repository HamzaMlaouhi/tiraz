...
class MarketEventModel extends MarketEvent {
  ...
  static List<MarketEventModel> mock() => const [
        MarketEventModel(
          ...
          timeLabel: LocalizedText(ar: '4:00 م – 11:00 م', en: '4:00 PM – 11:00 PM'),
          totalSlots: 40,
          reservedSlots: 31,
          attendeeCount: 2400,
          isFree: false,
        ...
        MarketEventModel(
          ...
          timeLabel: LocalizedText(ar: '10:00 ص – 10:00 م', en: '10:00 AM – 10:00 PM'),
          totalSlots: 25,
          reservedSlots: 25,
          attendeeCount: 5100,
          isFree: false,
        ...
        MarketEventModel(
          ...
          timeLabel: LocalizedText(ar: '12:00 م – 9:00 م', en: '12:00 PM – 9:00 PM'),
          totalSlots: 18,
          reservedSlots: 9,
          attendeeCount: 900,
          isFree: true,
        ...
        MarketEventModel(
          ...
          timeLabel: LocalizedText(ar: '5:00 م – 10:00 م', en: '5:00 PM – 10:00 PM'),
          totalSlots: 30,
          reservedSlots: 6,
          attendeeCount: 1200,
          isFree: true,
