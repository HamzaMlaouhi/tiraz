...
/// ("the place"), whether it's free to join, and a reserve/cancel action
/// driven by [SellerCubit]. Tapping (anywhere but the button) opens the
/// full [EventDetailPage].
              ...
              children: [
                ...
                PositionedDirectional(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                        color: AppColors.card.withOpacity(0.92), borderRadius: BorderRadius.circular(999)),
                ...
                PositionedDirectional(
                  ...
                  child: Container(
                    padding: const EdgeInsets.symmetric(horizontal: 9, vertical: 4),
                    decoration: BoxDecoration(
                      color: event.isFree ? AppColors.teal : AppColors.card.withOpacity(0.92),
                      borderRadius: BorderRadius.circular(999),
                    ),
                    child: Text(
                      event.isFree ? l10n.sellerEventFreeLabel : formatAed(event.feeAed.round(), locale),
                      style: AppTextStyles.caption.copyWith(
                        color: event.isFree ? AppColors.card : AppColors.textPrimary,
                        fontSize: 11,
                      ),
                    ),
                  ),
            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    children: [
                      const Icon(Icons.groups_outlined, size: 13, color: AppColors.textMuted),
                      const SizedBox(width: 3),
                      Text(
                        l10n.sellerEventAttendeesCount(event.attendeeCount.toString()),
                        style: AppTextStyles.bodyMuted.copyWith(fontSize: 12),
                      ),
                      const SizedBox(width: 10),
                      Text('·', style: AppTextStyles.bodyMuted.copyWith(fontSize: 12)),
                      const SizedBox(width: 10),
                      Text(
                        full ? l10n.sellerSlotsFull : l10n.sellerSlotsLeft(event.slotsLeft.toString()),
                        style: AppTextStyles.caption
                            .copyWith(color: full ? AppColors.error : AppColors.teal, fontSize: 11.5),
                      ),
                    ],
                  ),
